...
public class KenvyraVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "KenvyraVersionDialogCtrl";
    private static final int DELAY_TIMER_MILLIS = 500;
    private static final int ACTIVITY_TRIGGER_COUNT = 3;

    private static final String KEY_KENVYRA_VERSION_PROP = "ro.modversion";
    ...
    public KenvyraVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
	...
	String[] kenvyraVer = SystemProperties.get(KEY_KENVYRA_VERSION_PROP).split("v");
	...
	if (!kenvyraVer[1].isEmpty() && !kenvyraReleasetype.isEmpty() && !kenvyraZiptype.isEmpty())
	    return kenvyraVer[1] + " | " + kenvyraZiptype + " | " + kenvyraReleasetype;
	else
